...
const siteSettingsRoutes = require('./site-settings.routes');
const storeLocationRoutes = require('./store-location.routes');
...
const contactMessageRoutes = require('./contact-message.routes');
